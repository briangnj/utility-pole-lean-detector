...
bashexport ROBOFLOW_API_KEY=your_key_here
...
bashpython pass1_collect.py hero_sdr.mp4 \
...
bashpython select_best_frames.py pass1_records.jsonl --out selection.json

The annotated hero video.

bashpython pass2_render_v2.py hero_sdr.mp4 \
...
bashpython build_pole_map.py hero_sdr.mp4 \
    --records pass1_records.jsonl --selection selection.json \
    --sensor-csv sensor.csv --hero-start-se 254.56 \
    --out map.html
...
bashpython build_pole_map.py --segments segments.json --out neighborhood.html
...
Licensed under the Apache License, Version 2.0. You are free to use, modify, and distribute this code, including commercially, as long as you keep the license and copyright notices and note any significant changes you make. The code is provided as is, without warranty. See the LICENSE file for the full text.
